...
async fn main() {
    ...
    let state = Arc::new(AppState {
        core_url: env("CORE_ENGINE_URL", "http://core-engine:8114"),
    ...
    tracing::info!("API Gateway (Audio) on {addr}");
...
async fn license_handler() -> (HeaderMap, Json<LicenseInfo>) {
    ...
    (h, Json(LicenseInfo {
        ...
        source_code: "https://github.com/ext-sakamoro/ALICE-Audio-SaaS".into(),
